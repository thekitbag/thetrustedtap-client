...
const Segment = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7b0aeabf078ca075d0ea1d5e92d84b9e7f1cefef', role: "tablist", onClick: this.onClick, class: theme.createColorClasses(this.color, {
                [mode]: true,
            ...
            }) }, index.h("slot", { key: 'ddecf3510bbc3cd37b2bbd7818b19f9919c767b5' })));
    }
